            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" action="{{url('admin/login')}}" method="post">
                ...
                <div class="form-group">
                  <input type="text" name="email" class="form-control form-control-lg @error('email') is-invalid @enderror" placeholder="Username" value="{{ old('email') }}">
                  @error('email')
                ...
                <div class="mt-3">
                  <button type="submmit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">SIGN IN</button>
                </div>
